...
public abstract class Vaisseau{
    ...
    protected int tonnagePersonne(int tonnage) {
        ...
        if (type.nom != "com.espacex.com.espacex.com.espacex.com.espacex.com.espacex.decouverte.enginsspatiaux.Vaisseau-Monde" && type.nom != "Cargo")
        {
            if (nbPassagers < 12)
                rejeter =  tonnage + tonnageActuel;
            else if ((tonnage + tonnageActuel) < (nbPassagers * 2) && (tonnage + tonnageActuel) < tonnageMax) {
                rejeter = 0;
            }
    ...
    public abstract int emporterCargaison(int tonnage) throws DepassementTonnageException;
}
