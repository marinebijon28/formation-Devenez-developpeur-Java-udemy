...
public class HelloUniverse {
    ...
    public static void main(String... args) throws DepassementTonnageException {
       ...
       /* com.espacex.com.espacex.com.espacex.com.espacex.com.espacex.decouverte.objetsastro.Atmosphere at = new com.espacex.com.espacex.com.espacex.com.espacex.com.espacex.decouverte.objetsastro.Atmosphere();
       ...
       // com.espacex.com.espacex.com.espacex.com.espacex.com.espacex.decouverte.objetsastro.Planete[] planetsorted = (com.espacex.com.espacex.com.espacex.com.espacex.com.espacex.decouverte.objetsastro.Planete[]) galaxy.planetes.toArray();
            ...
            switch (planet) {
                ...
                case "Mars" :
                    ...
                    if (tellurique.restePlaceDisponible(civile)) {
                        ...
                        try {
                            if ((rejeter = civile.emporterCargaison(quantity)) == 0)
                                scan.nextLine();
                        } catch (DepassementTonnageException e) {
                            System.out.println(e.getMessage());
                            System.out.println("Voulez-vous embarquer la quantité " + e.tonnageEnExces + " sur votre vaisseau : (oui, non)");
                            scan.nextLine();
                            restart = scan.nextLine();
                            if (restart.equalsIgnoreCase("oui")){
                                quantity = civile.tonnageMax;
                                rejeter = civile.emporterCargaison(quantity);
                            }
                            else {
                                break;
                            }
                            // si oui quantite max quantity - rejet
                            //else
                            //break pou recommencer un nouveau vaisseau
                        }
                    }
                    break;
                default :
